...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "KHAN-MD~uy4HHBxC#c_IKUlFrvOP5EVfD3y6IgcZR4hG6SoaWMhptxzM_1os",
// add your Session Id 
...
// make true if you want auto reply on status 
AUTO_STATUS_MSG: process.env.AUTO_STATUS_MSG || "*`ඔයාගෙ ස්ටෙටස්  බැලුවා පැතියො ඉතිම් මගෙත් බලන්න දැම්ම ගිහිම් 🙈💐`*",
...
OWNER_NUMBER: process.env.OWNER_NUMBER || "94726409119",
...
DEV: process.env.DEV || "94726409119",
